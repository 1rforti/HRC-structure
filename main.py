...
def open_link_YT(event):
    webbrowser.open('https://youtu.be/menrJLgvrGU')
...
def run_main2_with_gif(stack_inicial):
    def start_process():
        ...
        process = subprocess.Popen(["C:\\HRCStructureHHHHeadsUp\\dist\\main2\\main2.exe", "--stack", stack_inicial], creationflags=subprocess.CREATE_NO_WINDOW)
        # Aguarde a conclusão do processo
        process.wait()
